...
- O worker de consolidação pode ser escalado horizontalmente para aumentar vazão de consumo da fila.
...
### Camada 1 - Absorver pico imediato
...
### Camada 2 - Aumentar confiabilidade operacional
...
- Implementar Outbox Pattern para garantir publicação de eventos após commit no banco.
...
### Camada 3 - Otimizar consolidação
...
### Camada 4 - Evoluir arquitetura distribuída
...
flowchart TD
    ...
    L1[Camada 1<br/>Escalar API e workers<br/>Ajustar recursos e pool]
    L2[Camada 2<br/>DLQ, retry, Outbox<br/>métricas e alertas]
    L3[Camada 3<br/>Batch, particionamento<br/>cache e read replica]
    L4[Camada 4<br/>serviços independentes<br/>broker de maior escala<br/>sharding e autoscaling]
